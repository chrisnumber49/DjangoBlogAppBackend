...
I started this project by using the command `django-admin startproject` to create the boilerplate of project, then create new app with command `python manage.py startapp`, dependency `pillow` were installed for for saving and serving static files to the client, `django-cors-headers` to allow resources to be accessed on other domains...
